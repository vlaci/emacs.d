...
#+begin_src emacs-lisp
  ...
  (use-package org
    ...
    (when-let ((agenda-dir (car org-agenda-files)))
      (setq org-capture-templates
            `(("i" "inbox" entry (file ,(expand-file-name "inbox.org" agenda-dir))
               "* TODO %?")
              ("e" "email" entry (file+headline ,(expand-file-name "emails.org" agenda-dir) "Emails")
               "* TODO [#A] Reply: %a :@home:@school:" :immediate-finish t)
              ("l" "link" entry (file ,(expand-file-name "inbox.org" agenda-dir))
               "* TODO %(org-cliplink-capture)" :immediate-finish t)
              ("c" "org-protocol-capture" entry (file ,(expand-file-name "inbox.org" agenda-dir))
  ...
  (use-package org-roam
    ...
    (global-leader-prefix
      ...
      "c" 'org-roam-capture
      ;; Dailies
      "d" '(:keymap org-roam-dailies-map :which-key "org-roam-dailies"))
    :init
