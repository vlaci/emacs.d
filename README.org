...
#+begin_src emacs-lisp
  ...
  (use-package window
    ...
    ;; display-buffer hint: avoid resizing
    (even-window-sizes nil)
    ;; Default rules
    (display-buffer-alist
     `(;; Embark Actions above minibuffer
       ("\\*Embark Actions\\*"
       ...
       ("\\*\\(Help\\|company-documentation\\|info\\|Man\\|WoMan\\)"
...
#+begin_src emacs-lisp
  (defvar vl-default-font (font-spec :name "Iosevka Comfy" :size 14))
  (defvar vl-sans-font (font-spec :name "Iosevka Comfy Duo" :size 14))
...
#+begin_src emacs-lisp
  ...
  (use-package org
    ...
    :init
    (setq vl-org-agenda-dir (if (boundp 'org-directory)
...
#+begin_src emacs-lisp
  (use-package eglot
    :init
    (defvar vl--eglot-pyright-executable "pyright")
    (defvar vl--eglot-rust-analyzer-executable "rust-analyzer")
    :config
    (setq eglot-server-programs `((python-mode . (,vl--eglot-pyright-executable "--stdio"))
                                  (rust-mode . ,vl--eglot-rust-analyzer-executable))))
...
#+begin_src emacs-lisp
  ...
  (use-package dumb-jump
    ...
    (defun vl--dumb-jump-nix-derivation-root (filepath)
    ...
    (advice-add #'dumb-jump-get-config :after-until #'vl--dumb-jump-nix-derivation-root))
#+end_src
